...
1. **[Books-Classifier](Books-Classifier/)**
   - Use XGBoost to classify books.

2. **[GBDT-XGBoost-LightGBM](GBDT-XGBoost-LightGBM/)**
   - Use XGBoost and LightGBM to predict whether a bicycle has a fault.

3. **[SVM-KNN-DT-RF-LR-NB-AdaBoost-Ensemble](SVM-KNN-DT-RF-LR-NB-AdaBoost-Ensemble/)**
