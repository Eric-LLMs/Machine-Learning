...
def randomForestClassifier_predict(train_file,unlabeled_file,unlabeled_data_file,train_data_file,train_target_file,test_data_file,test_target_file,unlabeled_result_file):
    ...
    import os
    test_data_pred_file = os.path.join(os.path.dirname(test_data_file),'test.file.vote.rf.npy')
