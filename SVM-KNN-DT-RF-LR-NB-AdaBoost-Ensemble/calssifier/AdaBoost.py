...
def adaBoostClassifier_predict(train_file,unlabeled_file,unlabeled_data_file,train_data_file,train_target_file,test_data_file,test_target_file,unlabeled_result_file):
    ...
    import os
    test_data_vote_file = os.path.join(os.path.dirname(test_data_file),'test.file.vote.ab.npy')
    output_data_array(test_data_vote_file,nb_test_predicted)
